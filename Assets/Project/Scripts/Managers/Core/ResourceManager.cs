...
namespace DongleSuika.Resource
{
    [UsedImplicitly]
    public class ResourceManager : ManagerBase
    {
        ...
        public GameObject? Instantiate(string key, Transform? parent = null, bool pooling = false)
        {
            ...
            if (prefab == null)
            {
                DongleDebugger.Log($"Failed to load prefab : {key}");
                return null;
            }
            ...
            if (pooling)
            {
                ...
                if (pool == null)
                {
                    DongleDebugger.LogError("Failed to get pool manager");
                    return null;
                }
...
#region Addressable
        ...
        public async UniTask LoadAllAsync<T>(string label, bool isDonDestroy = false) where T : Object
        {
            ...
            DongleDebugger.Log($"LoadAllAsync : {label}");
